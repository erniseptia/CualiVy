package app.project.cualivy.customview
...
class EmailEditText:AppCompatEditText {
    ...
    private fun init() {
        iconFormInput = ContextCompat.getDrawable(context, R.drawable.ic_baseline_email_24) as Drawable
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        context.apply {
            ...
            textSize = 16f
            setHintTextColor(ContextCompat.getColor(this, R.color.purple_500))
